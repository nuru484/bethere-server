// test/integration/api-docs.test.js
//
...
// it walks the router tree rather than the database, so it runs in CI without
// a Postgres service.
...
describe("API reference", () => {
  it("serves the OpenAPI document without a session", async () => {
    ...
    expect(res.body.info.title).toBe("BeThere API");
